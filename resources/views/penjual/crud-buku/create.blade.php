...
<div class="card shadow mb-4 mt-5">
    ...
    <div class="card-body">
        <form action="{{route('penjual-crud-buku.store')}}" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="text" name="author_buku" value="{{ old('author_buku')}}"
            ...
            <div class="form-group">
                ...
                <input type="text" name="penerbit_buku" value="{{ old('penerbit_buku')}}"
            ...
            <div class="form-group">
                ...
                <input type="date" name="tahun_terbit" value="{{ old('tahun_terbit')}}"
            ...
            <div class="form-group">
                ...
                <input type="number" name="harga_buku" value="{{ old('harga_buku')}}"
            ...
            <div class="form-group">
                ...
                <input id="deskripsi_buku" type="hidden" name="deskripsi_buku" value="{{old('deskripsi_buku')}}">
