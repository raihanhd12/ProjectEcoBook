...
<div class="card shadow mb-4 mt-5">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Edit Kurir</h6>
    </div>
    <div class="card-body">
        <form method="POST" action="{{route('admin-kurir.update', $data->id)}}">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                <select class="form-control" name="penjual_id" id="exampleFormControlSelect1">
                    ...
                    @if (old('penjual_id', $data->penjual_id) == $item->id)
            ...
            <div class="form-group">
                ...
                <input type="text" name="nama_kurir" value="{{ old('nama_kurir',$data->nama_kurir)}}"
